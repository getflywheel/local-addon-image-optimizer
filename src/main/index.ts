 ...
 * @returns ImageData[]
 */
export async function scanImages(siteID: string): Promise<SiteImageData> {
 ...
 * @param imageIds
 */
export async function compressImages(siteID: Local.Site['id'], imageMD5s: string[], stripMetaData?: boolean) {
	/**
