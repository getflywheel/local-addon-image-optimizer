...
export const ANALYTIC_EVENT_TYPES = {
	SCAN_START: `${BASE}scan${EVENT_LIFECYCLES.START}`, // done?
	SCAN_SUCCESS: `${BASE}scan${EVENT_LIFECYCLES.SUCCESS}`, // done?
	SCAN_FAILURE: `${BASE}scan${EVENT_LIFECYCLES.FAILURE}`, // done?
	SCAN_CANCEL: `${BASE}scan${EVENT_LIFECYCLES.CANCEL}`, // do not think this is a planned feature?
	OPTIMIZE_START: `${BASE}optimize${EVENT_LIFECYCLES.START}`, // done?
